/**
  * # Description
  * 
  * This module deploys a google_storage bucket to host a static website. Moreover, it also deploy the necessary front-end to deliver the content through CDN.
